 ...
 *
 * <p>This port defines the contract for logging REST API operations (GET, PUT, DELETE, POST)
 * to files in the resources/log directory with detailed information including:
...
public interface LoggingPort {
     ...
     */
    void logGet(String sessionId, String httpMethod, String endpoint, Integer statusCode,
     ...
     * @param error Error message (if status code indicates error, null otherwise)
     */
    void logPut(String sessionId, String httpMethod, String endpoint, Integer statusCode,
     ...
     * @param error Error message (if status code indicates error, null otherwise)
     */
    void logDelete(String sessionId, String httpMethod, String endpoint, Integer statusCode,
     ...
     * @param error Error message (if status code indicates error, null otherwise)
     */
    void logPost(String sessionId, String httpMethod, String endpoint, Integer statusCode,
