...
/**
 * Service for listening to REST API operations (GET, PUT, DELETE, POST).
 * Orchestrates listening through the ListenerPort.
 *
 * <p>This service is part of the Infrastructure layer and orchestrates
...
public class ListenerOperationService {
     ...
     */
    public ListenerOperationService(ListenerPort listenerPort) {
