 ...
 *
 * <p>This aspect intercepts REST controller methods and logs them automatically
...
public class LoggingAspect {
    ...
    /**
     * Record to encapsulate operation data for logging.
     *
    ...
    public Object logGetOperation(ProceedingJoinPoint joinPoint) throws Throwable {
        return logOperation(joinPoint, "GET");
    }
    ...
    public Object logPutOperation(ProceedingJoinPoint joinPoint) throws Throwable {
        return logOperation(joinPoint, "PUT");
    }
    ...
    public Object logPostOperation(ProceedingJoinPoint joinPoint) throws Throwable {
        return logOperation(joinPoint, "POST");
    }

    /**
     * Logs REST API operation with detailed information.
     ...
     * @throws Throwable if method execution fails
     */
    private Object logOperation(ProceedingJoinPoint joinPoint, String httpMethod) throws Throwable {
        ...
        try {
            ...
            logOperationData(operationData);
        }
    ...
    /**
     * Logs the operation using LogOperationUseCase.
     * Uses Switch Expression for elegant method dispatch.
     *
     * @param operationData Operation data to log
     */
    private void logOperationData(OperationData operationData) {
        switch (operationData.httpMethod()) {
            case "GET" -> logOperationUseCase.logGet(
                    operationData.httpMethod(), operationData.endpoint(), operationData.statusCode(),
                    operationData.entityType(), operationData.entityId(),
                    operationData.dataAfter(), operationData.error()
            );
            case "PUT" -> logOperationUseCase.logPut(
                    operationData.httpMethod(), operationData.endpoint(), operationData.statusCode(),
                    operationData.entityType(), operationData.entityId(),
                    operationData.dataBefore(), operationData.dataAfter(), operationData.error()
            );
            case "DELETE" -> logOperationUseCase.logDelete(
                    operationData.httpMethod(), operationData.endpoint(), operationData.statusCode(),
                    operationData.entityType(), operationData.entityId(),
                    operationData.dataBefore(), operationData.error()
            );
            case "POST" -> logOperationUseCase.logPost(
                    operationData.httpMethod(), operationData.endpoint(), operationData.statusCode(),
                    operationData.entityType(), operationData.entityId(),
